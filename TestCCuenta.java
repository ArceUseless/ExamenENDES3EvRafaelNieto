...
public class TestCCuenta {
	...
	public static void main(String[] args) {
		...
		int opcion = 0;
		RafaelNieto = new CCuenta("Rigoberta Piedra", "0000-6523-85-678912345",
				2500, 0);
		do {
			try {
				mostrarMenu();
				...
				switch (opcion) {
				case 1:
					ingresar(dato, RafaelNieto);
					break;
				case 2:
					retirar(dato, RafaelNieto);
					break;
				case 3:
		...
		System.out.println("Saldo actual: " + RafaelNieto.estado());
	}
